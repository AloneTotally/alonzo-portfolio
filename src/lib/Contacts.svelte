...
<div class="flex flex-col justify-evenly bg-slate-950 contacts-wrapper mt-10">
	...
	<div
		class="flex flex-col gap-3 items-center pl-10 sm:pl-0 sm:flex-row mt-10 justify-evenly mb-10"
	>
		...
		<!-- svelte-ignore a11y-mouse-events-have-key-events -->
		<a
			href="https://www.codewars.com/users/AloneTotally/badges"
			target="_blank"
			rel="noreferrer"
			class="flex justify-center items-center gap-5 hover:text-indigo-500 transition-colors duration-300"
			on:mouseover={() => (hoverBool['Codewars'] = true)}
			on:mouseleave={() => (hoverBool['Codewars'] = false)}
		>
			<svg
				role="img"
				viewBox="0 0 24 24"
				...
				width="40px"
				height="40px"
				fill={hoverBool['Codewars'] ? '#6366f1' : '#fff'}
				class="transition-colors duration-300"
				><title />
			...
			<p class="text-lg font-bold">Codewars</p>
		</a>
		<!-- svelte-ignore a11y-mouse-events-have-key-events -->
		<a
